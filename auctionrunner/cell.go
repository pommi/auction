...
func (c *Cell) ScoreForLRP(lrp *rep.LRP, startingContainerWeight float64, cellInstanceIndexWeight float64) (float64, error) {
	...
	indexScore := float64(c.state.CellIndex) * cellInstanceIndexWeight
