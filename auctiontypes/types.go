...
type RepPoolClient interface {
	...
	RebidThenTentativelyReserve(repAddresses []RepAddress, startAuctionInfo StartAuctionInfo) StartAuctionBids
	ReleaseReservation(repAddresses []RepAddress, startAuctionInfo StartAuctionInfo)
...
type AuctionRep interface {
	...
	RebidThenTentativelyReserve(startAuctionInfo StartAuctionInfo) (float64, error)
