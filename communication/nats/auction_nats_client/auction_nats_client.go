...
func (rep *AuctionNATSClient) RebidThenTentativelyReserve(repAddresses []auctiontypes.RepAddress, startAuctionInfo auctiontypes.StartAuctionInfo) auctiontypes.StartAuctionBids {
...
func (rep *AuctionNATSClient) ReleaseReservation(repAddresses []auctiontypes.RepAddress, startAuctionInfo auctiontypes.StartAuctionInfo) {
	releaseLog := rep.logger.Session("release-reservation", lager.Data{
		"start-auction-info":   startAuctionInfo,
		"rep-guids-to-release": repAddresses,
	})
